...
Entonces el sistema actualiza y muestra la medalla correspondiente automáticamente.
    ...
    <tr><td>TS-004</td><td>Obtener todos los usuarios</td><td>Como developer, quiero obtener todos los usuarios registrados para propósitos de administración.</td><td>Escenario 1: Dado que existen usuarios registrados, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de todos los usuarios.<br><br>Escenario 2: Dado que no hay usuarios registrados, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-001</td></tr>
    <tr><td>TS-005</td><td>Crear nuevo usuario</td><td>Como developer, quiero crear un nuevo usuario para permitir el registro en la plataforma.</td><td>Escenario 1: Dado que se envían datos válidos, Cuando se realiza la solicitud POST, Entonces se debe crear el usuario y devolver 201 Created.<br><br>Escenario 2: Dado que faltan campos obligatorios, Cuando se realiza la solicitud POST, Entonces la respuesta debe ser 400 Bad Request.</td><td>EP-001</td></tr>
    <tr><td>TS-006</td><td>Obtener entrega por ID</td><td>Como developer, quiero obtener una entrega específica por su ID para revisar su contenido.</td><td>Escenario 1: Dado que el ID de entrega es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver los detalles de la entrega.<br><br>Escenario 2: Dado que el ID de entrega no existe, Cuando se realiza la solicitud GET, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-003</td></tr>
    <tr><td>TS-007</td><td>Actualizar entrega</td><td>Como developer, quiero actualizar una entrega existente para permitir modificaciones.</td><td>Escenario 1: Dado que el ID de entrega es válido, Cuando se envía una solicitud PUT con datos válidos, Entonces se debe actualizar la entrega.<br><br>Escenario 2: Dado que el ID de entrega no existe, Cuando se realiza la solicitud PUT, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-003</td></tr>
    <tr><td>TS-008</td><td>Eliminar entrega</td><td>Como developer, quiero eliminar una entrega específica para permitir la gestión de contenido.</td><td>Escenario 1: Dado que el ID de entrega es válido, Cuando se realiza la solicitud DELETE, Entonces se debe eliminar la entrega y devolver 204 No Content.<br><br>Escenario 2: Dado que el ID de entrega no existe, Cuando se realiza la solicitud DELETE, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-003</td></tr>
    <tr><td>TS-009</td><td>Obtener todas las entregas</td><td>Como developer, quiero obtener todas las entregas existentes para propósitos de administración.</td><td>Escenario 1: Dado que existen entregas, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de todas las entregas.<br><br>Escenario 2: Dado que no hay entregas, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-003</td></tr>
    <tr><td>TS-010</td><td>Crear nueva entrega</td><td>Como developer, quiero crear una nueva entrega para permitir a los estudiantes enviar sus trabajos.</td><td>Escenario 1: Dado que se envían datos válidos, Cuando se realiza la solicitud POST, Entonces se debe crear la entrega y devolver 201 Created.<br><br>Escenario 2: Dado que faltan campos obligatorios, Cuando se realiza la solicitud POST, Entonces la respuesta debe ser 400 Bad Request.</td><td>EP-003</td></tr>
    <tr><td>TS-011</td><td>Obtener entregas por estudiante</td><td>Como developer, quiero obtener todas las entregas de un estudiante específico para revisar su progreso.</td><td>Escenario 1: Dado que el ID de estudiante es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de sus entregas.<br><br>Escenario 2: Dado que el estudiante no tiene entregas, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-003</td></tr>
    <tr><td>TS-012</td><td>Obtener entregas por estudiante y reto</td><td>Como developer, quiero obtener las entregas específicas de un estudiante para un reto particular.</td><td>Escenario 1: Dado que el estudiante y reto existen, Cuando se realiza la solicitud GET, Entonces se debe devolver las entregas correspondientes.<br><br>Escenario 2: Dado que no hay entregas para esa combinación, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-003</td></tr>
    <tr><td>TS-013</td><td>Obtener entregas por reto</td><td>Como developer, quiero obtener todas las entregas para un reto específico para evaluar el desempeño general.</td><td>Escenario 1: Dado que el ID de reto es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de entregas para ese reto.<br><br>Escenario 2: Dado que no hay entregas para ese reto, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-003</td></tr>
    <tr><td>TS-014</td><td>Obtener grupo por ID</td><td>Como developer, quiero obtener un grupo por su ID para verificar que la API devuelve los detalles correctos del grupo.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver los detalles del grupo.<br><br>Escenario 2: Dado que el ID del grupo no existe, Cuando se realiza la solicitud GET, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-001</td></tr>
    <tr><td>TS-015</td><td>Actualizar grupo</td><td>Como developer, quiero actualizar la información de un grupo existente para mantener los datos actualizados.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se envía una solicitud PUT con datos válidos, Entonces se debe actualizar el grupo.<br><br>Escenario 2: Dado que el ID del grupo no existe, Cuando se realiza la solicitud PUT, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-001</td></tr>
    <tr><td>TS-016</td><td>Eliminar grupo</td><td>Como developer, quiero eliminar un grupo por su ID para permitir la gestión de grupos.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se realiza la solicitud DELETE, Entonces se debe eliminar el grupo y devolver 204 No Content.<br><br>Escenario 2: Dado que el ID del grupo no existe, Cuando se realiza la solicitud DELETE, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-001</td></tr>
    <tr><td>TS-017</td><td>Obtener código de unión de grupo</td><td>Como developer, quiero obtener el código de unión de un grupo para permitir que nuevos miembros se unan.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver el código de unión.<br><br>Escenario 2: Dado que el grupo no tiene código de unión, Cuando se realiza la solicitud GET, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-001</td></tr>
    <tr><td>TS-018</td><td>Establecer código de unión de grupo</td><td>Como developer, quiero establecer un código de unión para un grupo para controlar el acceso.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se envía una solicitud PUT con un código válido, Entonces se debe establecer el código de unión.<br><br>Escenario 2: Dado que el ID del grupo no existe, Cuando se realiza la solicitud PUT, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-001</td></tr>
    <tr><td>TS-019</td><td>Restablecer código de unión de grupo</td><td>Como developer, quiero restablecer el código de unión de un grupo para invalidar el código anterior.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se realiza la solicitud PUT, Entonces se debe generar un nuevo código de unión.<br><br>Escenario 2: Dado que el ID del grupo no existe, Cuando se realiza la solicitud PUT, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-001</td></tr>
    <tr><td>TS-020</td><td>Obtener todos los grupos</td><td>Como developer, quiero obtener todos los grupos existentes para propósitos de administración.</td><td>Escenario 1: Dado que existen grupos, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de todos los grupos.<br><br>Escenario 2: Dado que no hay grupos, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-001</td></tr>
    <tr><td>TS-021</td><td>Crear nuevo grupo</td><td>Como developer, quiero crear un nuevo grupo para permitir la organización de estudiantes.</td><td>Escenario 1: Dado que se envían datos válidos, Cuando se realiza la solicitud POST, Entonces se debe crear el grupo y devolver 201 Created.<br><br>Escenario 2: Dado que faltan campos obligatorios, Cuando se realiza la solicitud POST, Entonces la respuesta debe ser 400 Bad Request.</td><td>EP-001</td></tr>
    <tr><td>TS-022</td><td>Unirse a grupo con código</td><td>Como developer, quiero permitir que un usuario se una a un grupo usando un código de unión válido.</td><td>Escenario 1: Dado que el código es válido, Cuando se realiza la solicitud POST, Entonces el usuario debe unirse al grupo.<br><br>Escenario 2: Dado que el código no es válido, Cuando se realiza la solicitud POST, Entonces la respuesta debe ser 400 Bad Request.</td><td>EP-001</td></tr>
    <tr><td>TS-023</td><td>Obtener reto por ID</td><td>Como developer, quiero obtener un reto por su ID para verificar que la API devuelve los detalles correctos del reto.</td><td>Escenario 1: Dado que el ID del reto es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver los detalles del reto.<br><br>Escenario 2: Dado que el ID del reto no existe, Cuando se realiza la solicitud GET, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-003</td></tr>
    <tr><td>TS-024</td><td>Actualizar reto</td><td>Como developer, quiero actualizar un reto existente para permitir modificaciones.</td><td>Escenario 1: Dado que el ID del reto es válido, Cuando se envía una solicitud PUT con datos válidos, Entonces se debe actualizar el reto.<br><br>Escenario 2: Dado que el ID del reto no existe, Cuando se realiza la solicitud PUT, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-003</td></tr>
    <tr><td>TS-025</td><td>Eliminar reto</td><td>Como developer, quiero eliminar un reto por su ID para permitir la gestión de contenido.</td><td>Escenario 1: Dado que el ID del reto es válido, Cuando se realiza la solicitud DELETE, Entonces se debe eliminar el reto y devolver 204 No Content.<br><br>Escenario 2: Dado que el ID del reto no existe, Cuando se realiza la solicitud DELETE, Entonces la respuesta debe ser 404 Not Found.</td><td>EP-003</td></tr>
    <tr><td>TS-026</td><td>Obtener todos los retos</td><td>Como developer, quiero obtener todos los retos existentes para propósitos de administración.</td><td>Escenario 1: Dado que existen retos, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de todos los retos.<br><br>Escenario 2: Dado que no hay retos, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-003</td></tr>
    <tr><td>TS-027</td><td>Crear nuevo reto</td><td>Como developer, quiero crear un nuevo reto para asignar a los grupos.</td><td>Escenario 1: Dado que se envían datos válidos, Cuando se realiza la solicitud POST, Entonces se debe crear el reto y devolver 201 Created.<br><br>Escenario 2: Dado que faltan campos obligatorios, Cuando se realiza la solicitud POST, Entonces la respuesta debe ser 400 Bad Request.</td><td>EP-003</td></tr>
    <tr><td>TS-028</td><td>Obtener retos por grupo</td><td>Como developer, quiero obtener todos los retos asignados a un grupo específico.</td><td>Escenario 1: Dado que el ID del grupo es válido, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista de retos asignados.<br><br>Escenario 2: Dado que no hay retos asignados, Cuando se realiza la solicitud GET, Entonces se debe devolver una lista vacía.</td><td>EP-003</td></tr>
  </tbody>
</table>
...
| Departamento                        | Lima, Perú                                                                                                                                                                                                             |
| Minuto de inicio                    | 00:00 min                                                                                                                                                                                                              |
| Captura de la Entrevista            | <img src="images/chapter-5/entrevista-Fiorella.png" alt="Insights" width="350">                                                                                                                                                                  |
